...
VALUES
    (1, 1, 'Introduction: callbacks', 'Many actions in JavaScript are asynchronous. In other words, we initiate them now, but they finish later.', 'https://javascript.info/callbacks'),
    --article
    (1, 2, 'rem vs em in CSS?', 'Difference between em and rem in css', 'https://stackoverflow.com/questions/13941275/how-does-rem-differ-from-em-in-css'),
    --article
    (2, 1, 'Computer programming', 'Comprehensive program, free of charge from Khan Academy.', 'https://www.khanacademy.org/computing/computer-programming'),
    --online course
    (2, 1, 'Array.map()', 'Basic intro to the array map function.', 'https://www.w3schools.com/jsref/jsref_map.asp'),
    --article
